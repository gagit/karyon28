	...
	_injectTimePicker: function() {
		...
		if ($dp.find("div#ui-timepicker-div-"+ dp_id).length === 0 && o.showTimepicker) {
			var noDisplay = ' style="display:none;"',
			    estiloEtiquetaTituloHorario = 'style="text-align:center;  font-weight: bold;"',
				html =	'<div class="ui-timepicker-div"  id="ui-timepicker-div-' + dp_id + '"><dl>' +
						'<dt class="ui_tpicker_time_label" ' + estiloEtiquetaTituloHorario + ' id="ui_tpicker_time_label_' + dp_id + '"' +
						((o.showTime) ? '' : noDisplay) + '>' + o.timeText + '</dt>' +
						'<dd class="ui_tpicker_time" ' + estiloEtiquetaTituloHorario + ' id="ui_tpicker_time_' + dp_id + '"' +
						((o.showTime) ? '' : noDisplay) + '> <br></dd>' +
